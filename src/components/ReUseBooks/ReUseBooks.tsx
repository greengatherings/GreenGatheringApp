        ...
        <div style={{ textAlign: 'center', backgroundColor: '#f0f8ff', padding: '20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{ textAlign: 'left' }}>
                    ...
                    <p style={{ fontSize: '1.3em' }}>We are thrilled to announce the successful completion of the ReUse School Books 2024! With over 745 requirements registered, we are proud to report that 55% of participants were able to find a perfect match for their needs. This remarkable achievement highlights the power of community and the importance of sustainability in education.</p>
                    <br />
